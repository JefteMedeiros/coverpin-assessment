...
export function SelectTrigger({ className, children, ...props }: SelectTriggerProps) {
  return (
    <ListboxButton
      className={cn(
        "placeholder:text-muted-foreground bg-zinc-800 dark:bg-input/30 border-zinc-500 flex items-center h-9 w-full min-w-0 rounded-md border px-3 py-1 text-base text-input shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
